...
class _$LoadingImpl implements _Loading {
  ...
  @override
  String toString() {
    return 'CategoryState.loading(silent: $silent)';
  }
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Category> items}) : _items = items;
...
abstract class _Success implements CategoryState {
  const factory _Success({required final List<Category> items}) = _$SuccessImpl;
